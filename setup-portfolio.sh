    ...
    "student-portfolio": {
      ...
      "architect": {
        "build": {
          ...
          "configurations": {
            "production": {
              "budgets": [{"type": "initial", "maximumWarning": "1024kb", "maximumError": "1mb"}],
              "outputHashing": "all"
            },
			"development": {}
          }
        ...
        "serve": {
          ...
          "configurations": {
            "production": {"buildTarget": "student-portfolio:build:production"},
            "development": {"buildTarget": "student-portfolio:build:development"}
          },
